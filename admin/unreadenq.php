...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0" style="color:red;">Unread Enquiry</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <thead>
                            ...
                            <tbody>
                                <?php
$ret=mysqli_query($conn,"select * from tblcontact where IsRead is null");
$cnt=1;
...
?>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td><a href="viewenquiry.php?viewid=<?php echo $row['ID'];?>"
                                        ...
                                        <a href="unreadenq.php?delid=<?php echo $row['ID'];?>" class="btn btn-sm btn-danger"
